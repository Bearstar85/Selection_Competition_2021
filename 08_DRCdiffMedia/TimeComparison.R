...
#First 1h#####
myData3= read.csv("Input/RO5_1h.csv", header=TRUE)
myData3
...
#First 3h####
myData2= read.csv("Input/RO5_3h.csv", header=TRUE)
myData2
#First look at the imported data
...
#Then 5 h####
myData4= read.csv("Input/RO5_5h.csv", header=TRUE)
myData4
...
#Make the plot####
myData= read.csv("Input/RO5_all.csv", header=TRUE)
myData
#First look at the imported data
...
dev.copy(pdf, "Results/FigTime.pdf")
dev.off()


sink("Results/ECvaluesTime.txt")

#report the EC50
ED(bestRO5_1h.WB, respLev = 0.5, type="absolute", interval="tfls") #to get ED help file put ? in front of ED and run. 
PLay = c(0.1, 0.5, 0.7, 0.9)
PLay
#report the EC05
ED(bestRO5_1h.WB, respLev = 0.05, type="absolute", interval="tfls") #to get ED help file put ? in front of ED and run. 
PLay = c(0.1, 0.5, 0.7, 0.9)
PLay
#report the EC95
ED(bestRO5_1h.WB, respLev = 0.95, type="absolute", interval="tfls") #to get ED help file put ? in front of ED and run. 
PLay = c(0.1, 0.5, 0.7, 0.9)
PLay

#report the EC50
ED(bestRO5_3h.WB, respLev = 0.5, type="absolute", interval="tfls") #to get ED help file put ? in front of ED and run. 
PLay = c(0.1, 0.5, 0.7, 0.9)
PLay
#report the EC05
ED(bestRO5_3h.WB, respLev = 0.05, type="absolute", interval="tfls") #to get ED help file put ? in front of ED and run. 
PLay = c(0.1, 0.5, 0.7, 0.9)
PLay
#report the EC95
ED(bestRO5_3h.WB, respLev = 0.95, type="absolute", interval="tfls") #to get ED help file put ? in front of ED and run. 
PLay = c(0.1, 0.5, 0.7, 0.9)
PLay

#report the EC50
ED(bestRO5_5h.WB, respLev = 0.5, type="absolute", interval="tfls") #to get ED help file put ? in front of ED and run. 
PLay = c(0.1, 0.5, 0.7, 0.9)
PLay
#report the EC05
ED(bestRO5_5h.WB, respLev = 0.05, type="absolute", interval="tfls") #to get ED help file put ? in front of ED and run. 
PLay = c(0.1, 0.5, 0.7, 0.9)
PLay
#report the EC95
ED(bestRO5_5h.WB, respLev = 0.95, type="absolute", interval="tfls") #to get ED help file put ? in front of ED and run. 
PLay = c(0.1, 0.5, 0.7, 0.9)
PLay
